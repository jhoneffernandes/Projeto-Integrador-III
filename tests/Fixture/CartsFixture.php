...
class CartsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'completed_at' => ['type' => 'datetime', 'length' => null, 'precision' => null, 'null' => false, 'default' => null, 'comment' => ''],
        ...
        '_constraints' => [
            ...
            'carts_ibfk_1' => ['type' => 'foreign', 'columns' => ['client_id'], 'references' => ['clients', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init(): void
    {
        $this->records = [
            [
                'id' => 1,
                'total' => 1.5,
                'created_at' => '2020-06-27 11:29:48',
                'completed_at' => '2020-06-27 11:29:48',
                'client_id' => 1,
            ],
        ];
        parent::init();
