...
<div class="row d-flex justify-content-center flex-column align-items-center">
    <div class="column">
        <div class="d-flex justify-content-between flex-column align-items-center">
            <h4 class="h1 text-center"><?= __('Cadastrar novo produto') ?></h4>
...
<h4 class="mx-5 my-4">
    ...
    <div class="column">
        <div class="produtos form content my-3 d-flex justify-content-center flex-column align-items-center text-center">
            ...
            <input class="form-control" name="preço" type="text" id="preço" />
            </div>

            <div class="form-group d-flex justfy-content-center flex-column">
            <label class="text-danger" for="descrição">Descrição</label>
            <textarea class="form-control" name="descrição" type="text" id="descrição"></textarea>
            </div>
