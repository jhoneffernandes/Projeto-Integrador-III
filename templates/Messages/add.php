...
<div class="row d-flex justify-content-center flex-column align-items-center">
    <div class="column">
        <div class="d-flex justify-content-between flex-column align-items-center">
            <h4 class="h1 text-center"><?= __('Cadastrar nova mensagem (teste)') ?></h4>
...
<h4 class="mx-5 my-4">
    ...
    <div class="column">
        <div class="messages form content my-3 d-flex justify-content-center flex-column align-items-center text-center">
            ...
            <input class="form-control" name="celular" type="number" id="celular" />
            </div>

            <div class="form-group d-flex justfy-content-center flex-column">
            <label class="text-danger" for="mensagem">Mensagem</label>
            <textarea class="form-control" name="mensagem" type="textarea" id="mensagem"></textarea>
            </div>
